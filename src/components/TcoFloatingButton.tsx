    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <button
          ...
          className="fixed bottom-24 left-4 md:bottom-6 md:left-6 z-[60] w-12 h-12 lg:w-14 lg:h-14 rounded-full bg-gradient-to-br from-accent to-primary text-primary-foreground shadow-xl shadow-primary/25 flex items-center justify-center transition-all hover:scale-110 active:scale-95 group"

      ...
      <main className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <section id="biv" className="mb-12 scroll-mt-20">
          ...
          <div className="text-muted-foreground text-sm leading-relaxed space-y-3">
            <p>
              De BIV wordt éénmalig geheven bij de eerste inschrijving van een voertuig in
              België. Het bedrag verschilt naargelang het <strong>gewest</strong>, de{" "}
              <strong>fiscale paardenkracht</strong> (PK) en de{" "}
              <strong>CO₂-uitstoot</strong>.
            </p>
            <p>
              In het <strong>Waals Gewest</strong> houdt de nieuwe BIV voortaan rekening
              met de fiscale paardenkracht, de CO₂-uitstoot, maar ook met de{" "}
              <strong>massa (MTM)</strong> en de <strong>leeftijd</strong> van het
              voertuig. In het <strong>Vlaams Gewest</strong> is het barema voornamelijk
              gebaseerd op de CO₂-uitstoot en de Euro-norm. In het{" "}
              <strong>Brussels Hoofdstedelijk Gewest</strong> blijft de belasting gebaseerd
              op de fiscale PK met aanmoedigingen voor zero-emissievoertuigen. Gebruik onze{" "}
        ...
        <section id="vb" className="mb-12 scroll-mt-20">
          ...
          <p className="text-muted-foreground text-sm leading-relaxed">
            De verkeersbelasting is jaarlijks verschuldigd voor elk in België ingeschreven
            voertuig. Het bedrag hangt af van het <strong>motorvermogen</strong>, het{" "}
            <strong>brandstoftype</strong> en het <strong>gewest</strong>. Let op: vanaf{" "}
            <strong>2026</strong> zijn volledig elektrische voertuigen niet langer
            volledig vrijgesteld bij een nieuwe inschrijving en schakelen ze over op{" "}
            <strong>minimum forfaitaire tarieven</strong>.
          </p>
        </section>
        ...
        <section id="aftrekbaarheid" className="mb-12 scroll-mt-20">
          ...
          <p className="text-muted-foreground text-sm leading-relaxed mb-6">
            De Belgische belastinghervorming wijzigt de aftrekbaarheid van autokosten
            radicaal. De besteldatum wordt doorslaggevend.
          </p>

          <div className="rounded-2xl border border-border bg-card overflow-hidden mb-4">
            <div className="px-5 py-4 border-b border-border bg-secondary/40">
              <p className="font-semibold text-sm">Samengevat: de gulden regel 2026</p>
            </div>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-border">
                    ...
                    <th className="text-left font-semibold px-5 py-3 text-foreground">Besteld in 2026 (nieuwe aankoop)</th>
                  </tr>
                </thead>
                <tbody className="text-muted-foreground">
                  ...
                  <tr className="border-b border-border/60">
                    ...
                    <td className="px-5 py-4 align-top">
                      ...
                      <span className="block text-xs mt-1">(behoudens zeldzame uitzonderingen in natuurlijke persoon)</span>
                    </td>
                  </tr>
                  <tr>
        ...
        <section id="vaa" className="mb-12 scroll-mt-20">
          ...
          <p className="text-muted-foreground text-sm leading-relaxed mb-4">
            Het VAA wordt berekend op basis van de{" "}
            <strong className="text-foreground">cataloguswaarde van het voertuig BTW
            inbegrepen</strong>, een <strong className="text-foreground">CO₂-percentage</strong>{" "}
            (berekend volgens de nieuwe referentiewaarden van{" "}
            <strong className="text-foreground">70 g voor benzine</strong> en{" "}
            <strong className="text-foreground">58 g voor diesel</strong>) en een{" "}
            <strong className="text-foreground">leeftijdscoëfficiënt</strong>. Voor 2026
            blijft de formule:
          </p>
          <div className="rounded-2xl border border-border bg-secondary/40 p-4 mb-4">
            <p className="font-mono text-sm text-foreground text-center">
              VAA = Cataloguswaarde × 6/7 × % CO₂ × Leeftijdscoëfficiënt
            </p>
          </div>
          <div className="rounded-2xl border border-primary/30 bg-primary/5 p-4">
            <p className="text-sm text-foreground">
              Het wettelijk minimumbedrag van het VAA voor het jaar 2026 is vastgesteld op{" "}
              <strong className="text-primary">1 690 € per jaar</strong>.
            </p>
          </div>
        </section>

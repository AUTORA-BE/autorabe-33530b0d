...
const HelpButton = () => {
  ...
  return (
    <button
      ...
      aria-label={label}
      className="fixed z-40 above-bottom-nav left-4 md:!bottom-6 md:left-6 inline-flex items-center gap-2 rounded-full bg-card/90 backdrop-blur-md border border-border/40 text-foreground px-4 py-3 shadow-elevated hover:shadow-glow hover:border-primary/40 transition-all duration-200 hover:scale-105 active:scale-95"
    >

...
const HelpButton = () => {
  ...
  return (
    <button
      ...
      aria-label={label}
      className="fixed z-40 bottom-24 right-4 md:bottom-6 md:right-6 inline-flex items-center gap-2 rounded-full bg-primary text-primary-foreground px-4 py-3 shadow-glow hover:shadow-glow-lg transition-all duration-200 hover:scale-105 active:scale-95"
    >
